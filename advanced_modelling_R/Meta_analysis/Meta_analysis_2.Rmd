...
- $\tau^2_{REM}$ heterogeneity of Meta-regression
...
```{r bubble, fig.height=5, fig.width=5}
...
```{r egger}
metabias(res, k.min=7) # default is 10
```
...
- This technique is not widely used in meta-analysis
- It is availalbe in `metafor` package
